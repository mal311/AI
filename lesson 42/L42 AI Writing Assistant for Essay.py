...
def get_essay_details():
    ...
    # Additional details
    stance = input(Fore.YELLOW + "What is your stance on te topic?(e.g., For, Against, Neutral)")
    print()
    ...
    outline_needed = input(Fore.YELLOW + "Would you like the AI to suggest an outline fisry? (Yes/No)").lower()
